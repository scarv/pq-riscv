                        ...
                        uint8_t *k_r)
{
     ...
     **/
    shake256(e, NTS_KEM_PARAM_CEIL_N_BYTE, k_e, kNTSKEMKeysize);
    ...
    shake256(kr_in_buf, kNTSKEMKeysize + NTS_KEM_PARAM_CEIL_N_BYTE, k_r, kNTSKEMKeysize);
                        ...
                        uint8_t *k_r)
{
     ...
     **/
    shake256((const uint8_t *)e, NTS_KEM_PARAM_CEIL_N_BYTE, kr_in_buf, kNTSKEMKeysize);
#if defined(INTERMEDIATE_VALUES)
     ...
     **/
    shake256(xof_buf, kNTSKEMKeysize + NTS_KEM_PARAM_CEIL_N_BYTE, k_r, kNTSKEMKeysize);
